 ...
 *
 * HTTP itself now keeps the anonymous youtube.com cookie session alive, so a
 * retry can benefit from any Set-Cookie updates made by the preceding player
 * response. No visitorData synthesis is done here.
 */
